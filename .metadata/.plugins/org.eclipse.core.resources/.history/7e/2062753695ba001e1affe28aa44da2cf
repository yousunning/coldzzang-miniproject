...
<body>
    ...
    <a href="/food/List/myRefrigerator" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">로그인</a>
    <a href="/food/List/homepage" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">차갑짱 홈페이지</a>
    <a href="/food/List/join" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">회원가입</a>
</div>
